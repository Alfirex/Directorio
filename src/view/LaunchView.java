...
public class LaunchView extends JFrame {
	...
	public LaunchView() {
        ...
        btnCompararPalabras = new JButton("Comparar Caracter Palabra");
        panel.add(btnCompararPalabras);
	...
	public JButton getBtnAnyo() {
		return btnAnyo;
	}

	public void setBtnAnyo(JButton btnAnyo) {
		this.btnAnyo = btnAnyo;
	}

	public JButton getBtnCompararPalabra() {
		return btnCompararPalabras;
	}

	public void setBtnRecuperarLibrosAnyo(JButton btnRecuperarLibrosAnyo) {
		this.btnCompararPalabras = btnRecuperarLibrosAnyo;
	}
